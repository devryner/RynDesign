...
| 문서 | 한국어 | English |
|------|--------|---------|
| 설정 레퍼런스 | [configuration.md](./docs/ko/configuration.md) | [configuration.md](./docs/configuration.md) |
| 토큰 스펙 | [token-spec.md](./docs/ko/token-spec.md) | [token-spec.md](./docs/token-spec.md) |
| 컴포넌트 정의 스펙 | [component-spec.md](./docs/ko/component-spec.md) | [component-spec.md](./docs/component-spec.md) |
| 제너레이터 | [generators.md](./docs/ko/generators.md) | [generators.md](./docs/generators.md) |
| CLI 레퍼런스 | [cli.md](./docs/ko/cli.md) | [cli.md](./docs/cli.md) |
| Figma 연동 | [figma-integration.md](./docs/ko/figma-integration.md) | [figma-integration.md](./docs/figma-integration.md) |
